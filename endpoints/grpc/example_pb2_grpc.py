...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ClientStream = channel.stream_unary(
                '/example.Greeter/ClientStream',
                request_serializer=example__pb2.ClientMessage.SerializeToString,
                response_deserializer=example__pb2.ServerResponse.FromString,
                _registered_method=True)
        self.BidirectionalStream = channel.stream_stream(
                '/example.Greeter/BidirectionalStream',
                request_serializer=example__pb2.ClientMessage.SerializeToString,
                response_deserializer=example__pb2.ServerResponse.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ClientStream': grpc.stream_unary_rpc_method_handler(
                    ...
                    response_serializer=example__pb2.ServerResponse.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def ClientStream(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            example__pb2.ServerResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
